 ...
 * @author juald
 */
public class VueloCompañiaTablas extends DefaultTableModel {

    private VistaVuelosCompañia vVuelo;
     ...
     * @param vVuelo
     */
    public VueloCompañiaTablas(VistaVuelosCompañia vVuelo) {
        this.vVuelo = vVuelo;
     ...
     * @param vVuelo
     */
    public void dibujarTablaVuelos(VistaVuelosCompañia vVuelo) {
